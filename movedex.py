MoveDex = {
	...
	"acupressure": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises a random stat by 2 stages as long as the stat is not already at stage 6. The user can choose to use this move on it'self' or an adjacent ally. Fails if no stat stage can be raised or if used on an ally with a substitute.",
	...
	"agility": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's 'spe'ed by 2 stages.",
		'shortDesc': "Raises the user's 'spe'ed by 2.",
		'id': "agility",
		'isViable': True,
		'name': "Agility",
		'pp': 30,
	...
	"ancientpower": {
		...
		'basePower': 60,
		'category': "special",
		'desc': "Has a 10% chance to raise the user's Attack, defense, special Attack, special defense, and 'spe'ed by 1 stage.",
	...
	"auroraveil": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "For 5 turns, the user and its party members take 0.5x damage from physical and special attacks, or 0.66x damage if in a Double Battle. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or 'def'og. Lasts for 8 turns if the user is holding Light Clay. Fails unless the 'weather' is Hail.",
	...
	"autotomize": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's 'spe'ed by 2 stages. If the user's 'spe'ed was changed, the user's weight is reduced by 100kg as long as it remains active. This effect is stackable but cannot reduce the user's weight to less than 0.1kg.",
		'shortDesc': "Raises the user's 'spe'ed by 2; user loses 100 kg.",
		'id': "autotomize",
		'isViable': True,
		'name': "Autotomize",
		'pp': 15,
	...
	"bide": {
		...
		'basePower': 0,
		'category': "Physical",
		'desc': "The user 'spe'nds two turns locked into this move and then, on the second turn after using this move, the user attacks the last Pokemon that hit it, inflicting double the damage in HP it lost during the two turns. If the last Pokemon that hit it is no longer on the field, the user attacks a random foe instead. If the user is prevented from moving during this move's use, the effect ends. This move does not check accuracy.",
	...
	"blastburn": {
		...
		'basePower': 150,
		'category': "special",
		'desc': "If this move is successful, the user must re'charge' on the following turn and cannot make a move.",
	...
	"bounce": {
		...
		'basePower': 85,
		'category': "Physical",
		'desc': "Has a 30% chance to paralyze the target. This attack 'charge's on the first turn and executes on the second. On the first turn, the user avoids all attacks other than Gust, Hurricane, Sky Uppercut, Smack Down, Thousand Arrows, Thunder, and Twister. If the user is holding a Power Herb, the move completes in one turn.",
	...
	"bubble": {
		...
		'basePower': 40,
		'category': "special",
		'desc': "Has a 10% chance to lower the target's 'spe'ed by 1 stage.",
		'shortDesc': "10% chance to lower the foe(s) 'spe'ed by 1.",
		'id': "bubble",
		'name': "Bubble",
		'pp': 30,
		'priority': 0,
	...
	"bubblebeam": {
		...
		'category': "special",
		'desc': "Has a 10% chance to lower the target's 'spe'ed by 1 stage.",
		'shortDesc': "10% chance to lower the target's 'spe'ed by 1.",
		'id': "bubblebeam",
		'name': "Bubble Beam",
		'pp': 20,
		'priority': 0,
	...
	"bulldoze": {
		...
		'basePower': 60,
		'category': "Physical",
		'desc': "Has a 100% chance to lower the target's 'spe'ed by 1 stage.",
		'shortDesc': "100% chance to lower adjacent Pkmn 'spe'ed by 1.",
		'id': "bulldoze",
		'name': "Bulldoze",
		'pp': 20,
		'priority': 0,
	...
	"camouflage": {
		...
		'shortDesc': "Changes user's type by terrain ('def'ault Normal).",
		'id': "camouflage",
		'name': "Camouflage",
		'pp': 20,
		'priority': 0,
	...
	"copycat": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user uses the last move used by any Pokemon, including it'self'. Fails if no move has been used, or if the last move used was Assist, Baneful Bunker, Belch, Bestow, Chatter, Circle Throw, Copycat, Counter, Covet, Destiny Bond, Detect, Dragon Tail, Endure, Feint, Focus Punch, Follow Me, Helping Hand, Hold Hands, King's Shield, Mat Block, Me First, Metronome, Mimic, Mirror Coat, Mirror Move, Nature Power, Protect, Rage Powder, Roar, Sketch, Sleep Talk, Snatch, Spiky Shield, Struggle, Switcheroo, Thief, Transform, Trick, or Whirlwind.",
	...
	"cottonspore": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Lowers the target's 'spe'ed by 2 stages.",
		'shortDesc': "Lowers the target's 'spe'ed by 2.",
		'id': "cottonspore",
		'name': "Cotton Spore",
		'pp': 40,
		'priority': 0,
	...
	"dig": {
		...
		'basePower': 80,
		'category': "Physical",
		'desc': "This attack 'charge's on the first turn and executes on the second. On the first turn, the user avoids all attacks other than Earthquake and Magnitude but takes double damage from them, and is also unaffected by 'weather'. If the user is holding a Power Herb, the move completes in one turn.",
	...
	"dive": {
		...
		'basePower': 80,
		'category': "Physical",
		'desc': "This attack 'charge's on the first turn and executes on the second. On the first turn, the user avoids all attacks other than Surf and Whirlpool but takes double damage from them, and is also unaffected by 'weather'. If the user is holding a Power Herb, the move completes in one turn.",
	...
	"dragondance": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's Attack and 'spe'ed by 1 stage.",
		'shortDesc': "Raises the user's Attack and 'spe'ed by 1.",
		'id': "dragondance",
		'isViable': True,
		'name': "Dragon Dance",
		'pp': 20,
	...
	"electroball": {
		...
		'basePower': 0,
		'category': "special",
		'desc': "The power of this move depends on (user's current 'spe'ed / target's current 'spe'ed), rounded down. Power is equal to 150 if the result is 4 or more, 120 if 3, 80 if 2, 60 if 1, 40 if less than 1.",
	...
	"electroweb": {
		...
		'category': "special",
		'desc': "Has a 100% chance to lower the target's 'spe'ed by 1 stage.",
		'shortDesc': "100% chance to lower the foe(s) 'spe'ed by 1.",
		'id': "electroweb",
		'name': "Electroweb",
		'pp': 15,
		'priority': 0,
	...
	"extremeevoboost": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's Attack, defense, special Attack, special defense, and 'spe'ed by 2 stages.",
	...
	"flame'charge'": {
		...
		'basePower': 50,
		'category': "Physical",
		'desc': "Has a 100% chance to raise the user's 'spe'ed by 1 stage.",
		'shortDesc': "100% chance to raise the user's 'spe'ed by 1.",
		'id': "flame'charge'",
		'isViable': True,
		'name': "Flame 'charge'",
		'pp': 20,
	...
	"fly": {
		...
		'basePower': 90,
		'category': "Physical",
		'desc': "This attack 'charge's on the first turn and executes on the second. On the first turn, the user avoids all attacks other than Gust, Hurricane, Sky Uppercut, Smack Down, Thousand Arrows, Thunder, and Twister. If the user is holding a Power Herb, the move completes in one turn.",
	...
	"freezeshock": {
		...
		'basePower': 140,
		'category': "Physical",
		'desc': "Has a 30% chance to paralyze the target. This attack 'charge's on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in one turn.",
		'shortDesc': "'charge's turn 1. Hits turn 2. 30% paralyze.",
		'id': "freezeshock",
		'name': "Freeze Shock",
		'pp': 5,
		'priority': 0,
	...
	"geomancy": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's special Attack, special defense, and 'spe'ed by 2 stages. This attack 'charge's on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in one turn.",
		'shortDesc': "'charge's, then raises 'spa', SpD, 'spe' by 2 turn 2.",
		'id': "geomancy",
		'isViable': True,
		'name': "Geomancy",
		'pp': 10,
	...
	"grasspledge": {
		...
		'basePower': 80,
		'category': "special",
		'desc': "If one of the user's allies chose to use Fire Pledge or Water Pledge this turn and has not moved yet, it takes its turn immediately after the user and the user's move does nothing. If combined with Fire Pledge, the ally uses Fire Pledge with 150 Base Power and a sea of fire appears on the target's side for 4 turns, which causes damage to non-Fire types equal to 1/8 of their maximum HP, rounded down, at the end of each turn during effect. If combined with Water Pledge, the ally uses Grass Pledge with 150 Base Power and a swamp appears on the target's side for 4 turns, which quarters the 'spe'ed of each Pokemon on that side. When used as a combined move, this move gains STAB no matter what the user's type is. This move does not consume the user's Grass Gem.",
	...
	"guardsplit": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user and the target have their defense and special defense stats set to be equal to the average of the user and the target's defense and special defense stats, re'spe'ctively, rounded down. Stat stage changes are unaffected.",
	...
	"gyroball": {
		...
		'basePower': 0,
		'category': "Physical",
		'desc': "Power is equal to (25 * target's current 'spe'ed / user's current 'spe'ed), rounded down, + 1, but not more than 150.",
	...
	"hammerarm": {
		...
		'basePower': 100,
		'category': "Physical",
		'desc': "Lowers the user's 'spe'ed by 1 stage.",
		'shortDesc': "Lowers the user's 'spe'ed by 1.",
		'id': "hammerarm",
		'isViable': True,
		'name': "Hammer Arm",
		'pp': 10,
	...
	"iceburn": {
		...
		'basePower': 140,
		'category': "special",
		'desc': "Has a 30% chance to burn the target. This attack 'charge's on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in one turn.",
		'shortDesc': "'charge's turn 1. Hits turn 2. 30% burn.",
		'id': "iceburn",
		'name': "Ice Burn",
		'pp': 5,
		'priority': 0,
	...
	"knockoff": {
		...
		'basePower': 65,
		'category': "Physical",
		'desc': "If the target is holding an item that can be removed from it, ignoring the Ability Sticky Hold, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item. This move cannot remove Z-Crystals, cause Pokemon with the Ability Sticky Hold to lose their held item, cause Pokemon that can Mega Evolve to lose the Mega Stone for their 'spe'cies, or cause a Kyogre, a Groudon, a Giratina, an Arceus, a Genesect, or a Silvally to lose their Blue Orb, Red Orb, Griseous Orb, Plate, Drive, or Memory re'spe'ctively. Items lost to this move cannot be regained with Recycle or the Ability Harvest.",
	...
	"lightscreen": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "For 5 turns, the user and its party members take 0.5x damage from special attacks, or 0.66x damage if in a Double or Triple Battle. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break or 'def'og. Lasts for 8 turns if the user is holding Light Clay.",
	...
	"lowsweep": {
		...
		'category': "Physical",
		'desc': "Has a 100% chance to lower the target's 'spe'ed by 1 stage.",
		'shortDesc': "100% chance to lower the target's 'spe'ed by 1.",
		'id': "lowsweep",
		'name': "Low Sweep",
		'pp': 20,
		'priority': 0,
	...
	"metronome": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "A random move is selected for use, other than After You, Assist, Belch, Bestow, Celebrate, Chatter, Copycat, Counter, Covet, Crafty Shield, Destiny Bond, Detect, Diamond Storm, Endure, Feint, Focus Punch, Follow Me, Freeze Shock, Happy Hour, Helping Hand, Hold Hands, Hyper'spa'ce Hole, Ice Burn, King's Shield, Light of Ruin, Mat Block, Me First, Metronome, Mimic, Mirror Coat, Mirror Move, Nature Power, Protect, Quash, Quick Guard, Rage Powder, Relic Song, Secret Sword, Sketch, Sleep Talk, Snarl, Snatch, Snore, Spiky Shield, Steam Eruption, Struggle, Switcheroo, Techno Blast, Thief, Thousand Arrows, Thousand Waves, Transform, Trick, V-create, or Wide Guard.",
	...
	"naturepower": {
		...
		'shortDesc': "Attack depends on terrain ('def'ault Tri Attack).",
		'id': "naturepower",
		'name': "Nature Power",
		'pp': 20,
		'priority': 0,
	...
	"phantomforce": {
		...
		'basePower': 90,
		'category': "Physical",
		'desc': "If this move is successful, it breaks through the target's Detect, King's Shield, Protect, or Spiky Shield for this turn, allowing other Pokemon to attack the target normally. If the target's side is protected by Crafty Shield, Mat Block, Quick Guard, or Wide Guard, that protection is also broken for this turn and other Pokemon may attack the target's side normally. This attack 'charge's on the first turn and executes on the second. On the first turn, the user avoids all attacks. If the user is holding a Power Herb, the move completes in one turn. Damage doubles and no accuracy check is done if the target has used Minimize while active.",
	...
	"powersplit": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user and the target have their Attack and special Attack stats set to be equal to the average of the user and the target's Attack and special Attack stats, re'spe'ctively, rounded down. Stat stage changes are unaffected.",
	...
	"powertrick": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user swaps its Attack and defense stats; stat stage changes remain on their re'spe'ctive stats. This move can be used again to swap the stats back. If the user uses Baton Pass, the replacement will have its Attack and defense stats swapped if the effect is active. If the user has its stats recalculated by changing forme while its stats are swapped, this effect is ignored but is still active for the purposes of Baton Pass.",
	...
	"quiverdance": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's special Attack, special defense, and 'spe'ed by 1 stage.",
		'shortDesc': "Raises the user's Sp. 'atk', Sp. 'def', 'spe'ed by 1.",
		'id': "quiverdance",
		'isViable': True,
		'name': "Quiver Dance",
		'pp': 20,
	...
	"razorwind": {
		...
		'basePower': 80,
		'category': "special",
		'desc': "Has a higher chance for a critical hit. This attack 'charge's on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in one turn.",
		'shortDesc': "'charge's, then hits foe(s) turn 2. High crit ratio.",
		'id': "razorwind",
		'name': "Razor Wind",
		'pp': 10,
		'priority': 0,
	...
	"reflect": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "For 5 turns, the user and its party members take 0.5x damage from physical attacks, or 0.66x damage if in a Double or Triple Battle. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break or 'def'og. Brick Break removes the effect before damage is calculated. Lasts for 8 turns if the user is holding Light Clay.",
	...
	"rest": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user falls asleep for the next two turns and restores all of its HP, curing it'self' of any major 'status' condition in the process. Fails if the user has full HP, is already asleep, or if another effect is preventing sleep.",
	...
	"round": {
		...
		'basePower': 60,
		'category': "special",
		'desc': "If there are other active Pokemon that chose this move for use this turn, those Pokemon take their turn immediately after the user, in 'spe'ed order, and this move's power is 120 for each other user.",
	...
	"safeguard": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "For 5 turns, the user and its party members cannot have major 'status' conditions or confusion inflicted on them by other Pokemon. It is removed from the user's side if the user or an ally is successfully hit by 'def'og.",
	...
	"secretpower": {
		...
		'basePower': 70,
		'category': "Physical",
		'desc': "Has a 30% chance to cause a secondary effect on the target based on the battle terrain. Causes paralysis on the regular Wi-Fi terrain, causes paralysis during Electric Terrain, lowers special Attack by 1 stage during Misty Terrain, causes sleep during Grassy Terrain and lowers 'spe'ed by 1 stage during Psychic Terrain. The secondary effect chance is not affected by the Ability Serene Grace.",
	...
	"shellsmash": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Lowers the user's defense and special defense by 1 stage. Raises the user's Attack, special Attack, and 'spe'ed by 2 stages.",
	...
	"shiftgear": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Raises the user's 'spe'ed by 2 stages and its Attack by 1 stage.",
		'shortDesc': "Raises the user's 'spe'ed by 2 and Attack by 1.",
		'id': "shiftgear",
		'isViable': True,
		'name': "Shift Gear",
		'pp': 10,
	...
	"skullbash": {
		...
		'basePower': 130,
		'category': "Physical",
		'desc': "This attack 'charge's on the first turn and executes on the second. Raises the user's defense by 1 stage on the first turn. If the user is holding a Power Herb, the move completes in one turn.",
	...
	"skyattack": {
		...
		'basePower': 140,
		'category': "Physical",
		'desc': "Has a 30% chance to flinch the target and a higher chance for a critical hit. This attack 'charge's on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in one turn.",
		'shortDesc': "'charge's, then hits turn 2. 30% flinch. High crit.",
		'id': "skyattack",
		'name': "Sky Attack",
		'pp': 5,
		'priority': 0,
	...
	"speedswap": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user swaps its raw 'spe'ed stat with the target.",
		'shortDesc': "Swaps 'spe'ed stat with target.",
		'id': "'spe'edswap",
		'name': "'spe'ed Swap",
		'pp': 10,
		'priority': 0,
	...
	"solarbeam": {
		...
		'basePower': 120,
		'category': "special",
		'desc': "This attack 'charge's on the first turn and executes on the second. Power is halved if the 'weather' is Hail, Rain Dance, or Sandstorm. If the user is holding a Power Herb or the 'weather' is Sunny Day, the move completes in one turn.",
		'shortDesc': "'charge's turn 1. Hits turn 2. No 'charge' in sunlight.",
		'id': "solarbeam",
		'name': "Solar Beam",
		'pp': 10,
		'priority': 0,
	...
	"stickyweb": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Sets up a hazard on the foe's side of the field, lowering the 'spe'ed by 1 stage of each foe that switches in, unless it is a Flying-type Pokemon or has the Ability Levitate. Can be used only once before failing. Can be removed from the foe's side if any foe uses Rapid Spin or 'def'og, or is hit by 'def'og.",
		'shortDesc': "Lowers 'spe'ed of grounded foes by 1 on switch-in.",
		'id': "stickyweb",
		'isViable': True,
		'name': "Sticky Web",
		'pp': 20,
	...
	"stoked'spa'rksurfer": {
		...
		'desc': "Has a 100% chance to paralyze the target.",
		'shortDesc': "100% chance to paralyze the target.",
		'id': "stoked'spa'rksurfer",
		'name': "Stoked 'spa'rksurfer",
		'pp': 1,
		'priority': 0,
		'flags': {},
		'isZ': "aloraichiumz",
	...
	"stringshot": {
		...
		'category': "'status'",
		'desc': "Lowers the target's 'spe'ed by 2 stages.",
		'shortDesc': "Lowers the foe(s) 'spe'ed by 2.",
		'id': "stringshot",
		'name': "String Shot",
		'pp': 40,
		'priority': 0,
	...
	"switcheroo": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "The user swaps its held item with the target's held item. Fails if either the user or the target is holding a Mail or Z-Crystal, if neither is holding an item, if the user is trying to give or take a Mega Stone to or from the 'spe'cies that can Mega Evolve with it, or if the user is trying to give or take a Blue Orb, a Red Orb, a Griseous Orb, a Plate, a Drive, or a Memory to or from a Kyogre, a Groudon, a Giratina, an Arceus, a Genesect, or a Silvally, re'spe'ctively. Pokemon with the Ability Sticky Hold are immune.",
	...
	"tailwind": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "For 4 turns, the user and its party members have their 'spe'ed doubled. Fails if this move is already in effect for the user's side.",
		'shortDesc': "For 4 turns, allies' 'spe'ed is doubled.",
		'id': "tailwind",
		'isViable': True,
		'name': "Tailwind",
		'pp': 15,
	...
	"toxicthread": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Lowers the target's 'spe'ed by 1 stage and poisons it.",
		'shortDesc': "Lowers the target's 'spe'ed by 1 and poisons it.",
		'id': "toxicthread",
		'isViable': True,
		'name': "Toxic Thread",
		'pp': 20,
	...
	"trickroom": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "For 5 turns, all active Pokemon with lower 'spe'ed will move before those with higher 'spe'ed, within their priority brackets. If this move is used during the effect, the effect ends.",
	...
	"uproar": {
		...
		'basePower': 90,
		'category': "special",
		'desc': "Deals damage to one adjacent foe at random. The user 'spe'nds three turns locked into this move. On the first of the three turns, all sleeping active Pokemon wake up. During the three turns, no active Pokemon can fall asleep by any means; Pokemon switched in during the effect do not wake up. If the user is prevented from moving or the attack is not successful against the target during one of the turns, the effect ends.",
	...
	"vcreate": {
		...
		'basePower': 180,
		'category': "Physical",
		'desc': "Lowers the user's 'spe'ed, defense, and special defense by 1 stage.",
		'shortDesc': "Lowers the user's defense, Sp. 'def', 'spe'ed by 1.",
		'id': "vcreate",
		'isViable': True,
		'name': "V-create",
		'pp': 5,
	...
	"venomdrench": {
		...
		'basePower': 0,
		'category': "'status'",
		'desc': "Lowers the target's Attack, special Attack, and 'spe'ed by 1 stage if the target is poisoned. Fails if the target is not poisoned.",
		'shortDesc': "Lowers 'atk', Sp. 'atk', 'spe'ed of poisoned foes by 1.",
		'id': "venomdrench",
		'name': "Venom Drench",
		'pp': 20,
		'priority': 0,
	...
	"waterpledge": {
		...
		'basePower': 80,
		'category': "special",
		'desc': "If one of the user's allies chose to use Fire Pledge or Grass Pledge this turn and has not moved yet, it takes its turn immediately after the user and the user's move does nothing. If combined with Fire Pledge, the ally uses Water Pledge with 150 Base Power and a rainbow appears on the user's side for 4 turns, which doubles secondary effect chances but does not stack with the Ability Serene Grace. If combined with Grass Pledge, the ally uses Grass Pledge with 150 Base Power and a swamp appears on the target's side for 4 turns, which quarters the 'spe'ed of each Pokemon on that side. When used as a combined move, this move gains STAB no matter what the user's type is. This move does not consume the user's Water Gem, and cannot be redirected by the Ability Storm Drain.",
